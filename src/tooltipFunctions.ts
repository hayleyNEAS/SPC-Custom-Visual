...
export function getTooltipData(d: SPCChartDataPoint, data: SPCChartData, formating: VisualSettingsModel): VisualTooltipDataItem[] {
  ...
  const header = {
    ...
    value: parseYLabels(<number>d.value, formating.enableYAxis.formatter.format.value.value == "time", data.decimalPlaces, data.measureFormat),
    color: d.color
  };
  tooltip_data = [header]
  ...
  if (data.target != -Infinity && formating.SPCSettings.lineOptions.showTarget.value) {
    const target = {
      displayName: "Target",
      value: parseYLabels(data.target, formating.enableYAxis.formatter.format.value.value == "time", formating.tooltipFormatting.SPCDecimal.value, data.measureFormat),
  ...
  if (formating.SPCSettings.lineOptions.showControl.value) {
    tooltip_data.push({
      ...
      value: parseYLabels(<number>d.UCLValue, formating.enableYAxis.formatter.format.value.value == "time", formating.tooltipFormatting.SPCDecimal.value, data.measureFormat),
      color: formating.SPCSettings.lineOptions.upperCL.value.value
    });

    tooltip_data.push({
      displayName: "Lower Control Limit",
      value: parseYLabels(<number>d.LCLValue, formating.enableYAxis.formatter.format.value.value == "time", formating.tooltipFormatting.SPCDecimal.value, data.measureFormat),
  ...
  if (formating.SPCSettings.lineOptions.showSubControl.value) {
    tooltip_data.push({
      ...
      value: parseYLabels(<number>d.Upper_Zone_A, formating.enableYAxis.formatter.format.value.value == "time", formating.tooltipFormatting.SPCDecimal.value, data.measureFormat),
      color: 'Black'
    });

    tooltip_data.push({
      displayName: "Lower Zone A Limit",
      value: parseYLabels(<number>d.Lower_Zone_A, formating.enableYAxis.formatter.format.value.value == "time", formating.tooltipFormatting.SPCDecimal.value, data.measureFormat),
      color: 'Black'
    });
