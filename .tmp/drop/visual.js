var SPCCharte052449909264a3487139638376f9e72_DEBUG;
/******/ (() => { // webpackBootstrap
...
function yAxisDomain(data) {
    ...
    let yData = dataPoints.map(d => d.value);
    let UCLData = dataPoints.map(d => d.UCLValue);
    let LCLData = dataPoints.map(d => d.LCLValue);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   i: () => (/* binding */ VisualSettingsModel)
/* harmony export */ });
...
class LineOptions extends SimpleCard {
    ...
    meanColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .ColorPicker */ .zH({
        name: "meanColor",
        displayName: undefined,
        value: { value: "black" }
    });
    showTarget = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .ToggleSwitch */ .Zh({
        name: "showTarget",
        displayName: "Show Target",
        value: true
    });
    targetColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .ColorPicker */ .zH({
        name: "targetColor",
        displayName: undefined,
        value: { value: "red" }
    });
    ...
    slices = [this.showControl, this.upperCL, this.lowerCL, this.showSubControl, this.showMean, this.meanColor, this.showTarget, this.targetColor];
}
...
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9264);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SPCCharte052449909264a3487139638376f9e72_DEBUG);

})();

SPCCharte052449909264a3487139638376f9e72_DEBUG = __webpack_exports__;
/******/ })()
;
